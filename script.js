...
const suspects = [
  {
    name: "Chef Mario",
    backstory: "The head chef who has been feeling underappreciated lately. Known for his fiery temper and perfectionism, Mario has hinted at 'teaching the owners a lesson.'",
    clues: [
  ...
  {
    name: "Luna the Waitress",
    backstory: "A waitress saving up to open her own restaurant. Luna recently got into trouble for sneaking ingredients out of the kitchen for her side hustle.",
    clues: [
  ...
  },
  {
    ...
    clues: [
      ...
      "A slice of pizza with extra pepperoni was left on his workbench."
    ]
  },
  {
    name: "Giovanni the Manager",
    backstory: "The strict restaurant manager who has been under pressure to cut costs. Rumors suggest Giovanni has been selling premium ingredients to competitors.",
    clues: [
  ...
  {
    name: "Emily the Food Critic",
    backstory: "A food critic who recently gave Pepperoni Palace a scathing review. Emily has been spotted frequently at rival restaurants.",
    clues: [
  ...
  {
    name: "Marco the Delivery Driver",
    backstory: "The delivery driver who is known for his love of pranks. Marco has been under scrutiny for frequently 'losing' deliveries.",
    clues: [
      "Security footage shows him near the storeroom during his break.",
      "Marco was seen sharing pizza with extra pepperoni at a party.",
  ...
  {
    name: "Sophia the Sous Chef",
    backstory: "Sophia is Chef Mario's apprentice and has been jealous of his success. She has been seeking a way to prove herself as the better chef.",
    clues: [
  ...
  {
    name: "Bruno the Regular Customer",
    backstory: "A pizza enthusiast and frequent customer who often demands special treatment. Bruno has a reputation for getting too 'hands-on' in the kitchen.",
    clues: [
